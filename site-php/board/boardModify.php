      ...
      <article class="content-article">
        <div class="boardType">
          ...
          <section class="boardModify">
            <form action="boardModifySava.php" name="boardModify" method="post">
              <fieldset>
                <legend class="ir_so">게시판 수정 영역 입니다.</legend>
                <?php
                  ...
                  if($result){
                    ...
                    echo "<div style='display:none'><label for='myMemberID'>작성자</label>";
                    echo "<input type='text' name='myMemberID' id='myMemberID' value='".$info['myMemberID']."'></div>";

                    echo "<div><label for='boardTitle'>제목</label>";
                    echo "<input type='text' name='boardTitle' id='boardTitle' class='title-text' value='".$info['boardTitle']."'></div>";
                    ...
                    echo "<input type='password' name='boardPass' id='boardPass' class='title-text' placeholder='로그인 비밀번호를 입력해주세요!!' autocomplete='off' required ></div>";
                  } 
                ?>
                <!-- 
                <div>
                ...
                <div>
                  ...
                  <input type="password" name="boardPass" id="boardPass" class="title-text" placeholder="로그인 비밀번호를 입력해주세요!!" autocomplete="off" required>
                </div> -->
              </fieldset>
