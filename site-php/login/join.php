                        ...
                        <fieldset>
                            ...
                            <div class="member-box">
                                ...
                                <div>
                                    ...
                                    <input type="password" name="youPassC" id="youPassC" class="input_write" maxlength="20" placeholder="다시 한번 비밀번호를 적어주세요!" autocomplete="off" required  />
                                </div>
                                <div>
