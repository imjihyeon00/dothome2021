                        ...
                        <fieldset>
                            ...
                            <div class="member-box">
                                <div>
                                    ...
                                    <input type="email" name="youEmail" id="youEmail" class="input_write" placeholder="Sample@naver.com" autocomplete="off" autofocus reqiured/>
                                </div>
                                <div>
                                    <label for="youPass">비밀번호</label>
                                    <input type="password" name="youPass" id="youPass" class="input_write" maxlength="20" placeholder="비밀번호를 적어주세요!" autocomplete="off" reqiured/>
                                </div>
                            </div>
                        </fieldset>
