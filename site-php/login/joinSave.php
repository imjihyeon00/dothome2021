      ...
      <article class="content-article">
        <div class="member-form">
          ...
          <?php 
            ...
            //echo $youEmail, $youPass, $youName, $youBirth, $youPhone;
            ...
            if( $check_phone == false) {
              msg("휴대폰 번호가 정확하지 않습니다. <br> 올바른 전화번호(000-0000-0000)를 적어주세요.");
              exit;
            }

            //중복 검사
            //데이터 가져오기 -> 유효성 검사 -> 중복검사 -> 회원가입
            //중복검사 -> 이메일, 핸드폰
            ...
            if( $result ) {
              ...
              if( $count == 0 ){
                ...
                msg("이미 가입된 회원 이메일 입니다. <br> 로그인을 해 주세요.");
                exit;
              }
            } else {
              msg("에러 발생!!01 - 관리자에게 문의하세요.");
              exit;
            }
            ...
            if( $result ) {
              ...
              if( $count == 0 ){
                ...
                msg("이미 작성된 번호 입니다. <br> 다른 번호를 입력 해 주세요.");
                exit;
              }
            } else {
              msg("에러 발생!!02 - 관리자에게 문의하세요.");
              exit;
            }
